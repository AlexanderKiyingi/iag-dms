...
func PermissionDescriptors() []PermissionDescriptor {
	return []PermissionDescriptor{
		...
		{Name: "dms.view_secondary", Description: "View the secondary-sales desk: van loads, retailer invoices, collections, returns, van closes"},
		{Name: "dms.manage_secondary", Description: "Record van loads, retailer invoices, collections, returns, van closes, rep targets and damage claims"},
		{Name: "dms.manage_schemes", Description: "Create and budget trade schemes"},
		{Name: "dms.override_credit", Description: "Supervisor: override an outlet's credit limit on a retailer invoice (reason is logged)"},
...
func PermissionCatalogData() map[string]any {
	keys := []string{
		...
		"dms.view_secondary", "dms.manage_secondary", "dms.manage_schemes", "dms.override_credit",
